...
contract SupplyChain is Ownable, FarmerRole, ConsumerRole, RetailerRole, DistributorRole {
    ...
    // Define 'owner'
    // address owner; Replaced by Ownable.sol
    ...
    modifier checkValue(uint _upc) {
        ...
        items[_upc].distributorID.transfer(amountToReturn); //Corrected from ConsumerID
    }
    ...
    constructor() public payable {
        // owner = msg.sender; Replaced by Ownable
        sku = 1;
        upc = 1;
    }
    ...
    function receiveItem(uint _upc) public onlyRetailer
        ...
        // Access Controlled by onlyRetailer
    ...
    function purchaseItem(uint _upc) public onlyConsumer
        ...
        // Access Control List enforced by calling Smart Contract / DApp
        // Access Controlled by onlyConsumer
